    ...
    return (
        <div className="bg-slate-900 flex items-center justify-center min-h-screen">
            <div className="flex flex-col items-center justify-center gap-4 p-4 text-white w-120 ">
                ...
                <div className='flex bg-slate-800 items-center justify-center text w-full mb-7 border border-gray-700 rounded p-9'>
                    <form action="#" className='flex flex-col justify-center text w-full my-7'>
                        ...
                        <div className="flex items-center justify-between gap-1">
                            <hr className="w-[25%] text-xl text-gray-700 mb-9" />
                            <p>or continue with</p>
                            <hr className="w-[25%] text-xl text-gray-700 mb-9" />
                        </div>
                        <div className='flex items-center justify-between text w-full'>
                            <span>
                                <img src="#" alt="Github" />
                                <a href="#">Github</a>
                            </span>
