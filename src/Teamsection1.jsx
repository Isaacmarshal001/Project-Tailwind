    ...
    return (
        <div>
            <div class="bg-gray-900 py-24 sm:py-32">
                <div class="mx-auto flex flex-col items-center justify-center text-center max-w-7xl gap-20 px-6 lg:px-8">
                    <div class="max-w-xl">
                        <h2 class="text-5xl font-bold tracking-tight text-white">Meet our team</h2>
