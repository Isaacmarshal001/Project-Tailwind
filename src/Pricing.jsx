    ...
    return (
        <div className="bg-slate-900 min-h-full min-w-full">
            <div className="mx-auto flex flex-col items-center text-center text-white font-sans w-[67%]">
                ...
                <div className="flex flex-row items-center justify-center text-left mt-20">
                    <div className="flex flex-col gap-4 border border-r-0 bg-slate-50/5 border-gray-700 w-107 rounded-4xl rounded-tr-none rounded-br-none p-9">
                        ...
                        <button className="bg-slate-100/15 p-2 rounded-sm font-bold mt-7">Get started today</button>
                    </div>
                    <div className="flex flex-col gap-4 border bg-slate-700/15 border-gray-700 w-107 rounded-4xl p-9 z-10 shadow-4xl shadow-black">
                        <p className="text-violet-500 font-bold">Enterprise</p>
